...
if __name__ == '__main__':
    ...
    ap.add_argument("-b", "--bag_file", required=True, help="The directory for mp4 video file")
    ...
    # initialize ros
    rospy.init_node('mp4_publisher')

    frame_info = '/sekonix_camera_a/port_a_camera_0/frame_info'
    publish_topic = '/sekonix_camera_a/port_a_camera_0/image_color'
